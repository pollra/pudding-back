...
class AccountTest {
	...
	public void idIsMoreThan20Characters(){
		assertThrows(IllegalArgumentException.class
				, ()-> AccountFactory.createNormalAccount("012345678901234567890", "0123456789", "0123456789", "0123456789"));
	}
	...
	public void anErrorOccursWhenTheNicknameIsLessThan8Characters() {
		assertThrows(IllegalArgumentException.class
				, ()-> AccountFactory.createNormalAccount("0123456789", "0", "0123456789", "0123456789"));
	}
	...
	public void anErrorOccursWhenTheNicknameIsMoreThan12Characters() {
		assertThrows(IllegalArgumentException.class
				, ()-> AccountFactory.createNormalAccount("0123456789", "0123456789012", "0123456789", "0123456789"));
	}
	...
	@Test
	@Order(7)
	@DisplayName("비밀번호가 틀렸을 경우 예외 발생")
	public void passwordCheckFail() {
		AccountFactory.createNormalAccount("0123456789", "012345678901", "0123456789", "11111111");
	}
	...
	public void createComplete() {
		AccountFactory.createNormalAccount("0123456789", "012345678901", "0123456789", "0123456789");
	}
}